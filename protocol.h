...
******************************************************************************/
#define PRODUCT_KEY "vxicifna"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//检测温度(只上报)
//备注:
#define DPID_WDJC 104
//加热输出(可下发可上报)
//备注:
#define DPID_JRSC 105
//制冷输出(可下发可上报)
//备注:
#define DPID_ZLSC 106
//设定温度(可下发可上报)
//备注:
#define DPID_SDWD 107
//电流方向(可下发可上报)
//备注:
#define DPID_DLFX 108
